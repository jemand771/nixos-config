...
let
  ...
  cats =
    pkgs.runCommand "vscode-pets-cats"
      {
        src = pkgs.fetchurl {
          url = "https://github.com/tonybaloney/vscode-pets/releases/download/${version}/vscode-pets-${version}.vsix";
  ...
  vsix = pkgs.buildNpmPackage {
    ...
    src = pkgs.fetchFromGitHub {
      ...
      repo = "vscode-pets";
      tag = version;
      hash = "sha256-Je1/67rk+n/yxsbtip3OiIM7JlEUQxn8handnX9OtGg=";
    };
    npmDepsHash = "sha256-zWT4YWwgFxOjDfqV6G/BODp5So5n+36rRVSWTRRhfQY=";
